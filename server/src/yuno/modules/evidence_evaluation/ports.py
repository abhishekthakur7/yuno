...
class EvidenceRepository(Protocol):
    ...
    def add_rubric(self, rubric: Rubric, dimensions: Sequence[RubricDimension]) -> Rubric: ...
    def get_rubric(self, owner_id: str, rubric_id: str) -> Rubric | None: ...
    def list_rubric_dimensions(self, owner_id: str, rubric_id: str) -> Sequence[RubricDimension]: ...
    def add_assessment(self, assessment: Assessment, dimensions: Sequence[AssessmentDimensionResult]) -> Assessment: ...
    def get_assessment(self, owner_id: str, assessment_id: str) -> Assessment | None: ...
    def get_active_assessment_for_evidence(self, owner_id: str, evidence_id: str) -> Assessment | None: ...
    def list_assessment_dimensions(self, owner_id: str, assessment_id: str) -> Sequence[AssessmentDimensionResult]: ...
    def list_disputes(self, owner_id: str, assessment_id: str) -> Sequence[AssessmentDispute]: ...
    def exclude_assessment(self, owner_id: str, goal_id: str, assessment_id: str) -> None: ...
    ...
    def add_reevaluation_request(self, request: ReevaluationRequest) -> ReevaluationRequest: ...
    def get_reevaluation_request(self, owner_id: str, request_id: str) -> ReevaluationRequest | None: ...
    def get_reevaluation_for_dispute(self, owner_id: str, dispute_id: str) -> ReevaluationRequest | None: ...
    def update_reevaluation_request(self, owner_id: str, request_id: str, changes: dict[str, object]) -> None: ...
    def add_idempotency(self, record: EvidenceEvaluationIdempotencyRecord) -> None: ...
    def get_idempotency(self, owner_id: str, operation: str, key: str) -> EvidenceEvaluationIdempotencyRecord | None: ...
    def complete_idempotency(self, owner_id: str, operation: str, key: str, response_json: str) -> None: ...
    def list_progress_evidence(self, owner_id: str, goal_id: str) -> Sequence[ProgressEvidence]: ...
...
class RoadmapTransferRepository(Protocol):
    ...
    def list_transferred_evidence_topic_ids(self, owner_id: str, goal_id: str) -> Sequence[str]: ...
    def list_progress_transfers(self, owner_id: str, goal_id: str) -> Sequence[object]: ...
    def list_evidence_transfers(self, owner_id: str, evidence_id: str) -> Sequence[object]: ...
